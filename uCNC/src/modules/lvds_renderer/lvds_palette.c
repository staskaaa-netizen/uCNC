...
static const lvds_palette_element_def_t g_element_def[LC_ELEM_COUNT] = {
    ...
    [LC_ELEM_SELECTED_TEXT] = {"main.selected_text", black},
    [LC_ELEM_ERROR] = {"main.error", red},
    [LC_ELEM_OK] = {"main.ok", green},
    [LC_ELEM_STOCK] = {"main.stock", white},
    [LC_ELEM_SELECTED_ROW] = {"main.selected_row", yellow},
    ...
    [LC_ELEM_CUT] = {"main.cut", yellow},
    [LC_ELEM_HATCH] = {"main.hatch", yellow},
    [LC_ELEM_TOOL] = {"main.tool", tool_orange},
    ...
    [LC_ELEM_PREVIEW_CUT] = {"preview.cut", yellow},
    [LC_ELEM_PREVIEW_HATCH] = {"preview.hatch", yellow},
    [LC_ELEM_PREVIEW_PROFILE] = {"preview.profile", red_bright},
    [LC_ELEM_PREVIEW_TOOL] = {"preview.tool", tool_orange}, //tool lines
    [LC_ELEM_PREVIEW_TOOL_MARK] = {"preview.tool_mark", tool_orange},
    [LC_ELEM_PREVIEW_TOOL_OUTLINE] = {"preview.tool_outline", tool_orange},
    ...
    [LC_ELEM_LIVE_TOOL] = {"live.tool", tool_orange}, //tool lines
    [LC_ELEM_LIVE_TOOL_MARK] = {"live.tool_mark", tool_orange},
    [LC_ELEM_LIVE_TOOL_OUTLINE] = {"live.tool_outline", tool_orange},
