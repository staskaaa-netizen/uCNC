 ...
 * Purpose: draw the bottom menu/status/footer area from snapshot data.
                              ...
                              int font)
{
    ...
    for (i = 0; i < fields; ++i) {
        ...
        bool active = false;
        lvds_color_t draw_button_bg = button_bg;
        lvds_color_t draw_button_fg = button_fg;
        ...
        if (active) {
            draw_button_bg = lvds_palette_element(LC_ELEM_FOOTER_VALUE);
            draw_button_fg = lvds_palette_element(LC_ELEM_FOOTER_TEXT);
        }
        ...
        lvds_draw_fill_rect(button_x, y, button_w, 22, draw_button_bg);
        ...
        lvds_draw_text_clip(button_x + 4, y + 3, label, (button_w - 8) / 8,
                            draw_button_fg, draw_button_bg, font);
