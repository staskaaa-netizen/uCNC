...
static volatile bool g_file_io_critical = false;

void cnc_set_file_io_critical(bool v)
{
    g_file_io_critical = v;
}

bool cnc_is_file_io_critical(void)
{
    return g_file_io_critical;
}
