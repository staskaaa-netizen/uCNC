...
bool nc_draw_center_arc(const nc_preview_info_t *preview, int z0_x, int stock_w, int stock_top, int stock_h, float start_x, float start_z, float end_x, float end_z, float i_off, float k_off, bool cw, lvds_color_t color, int width);
bool nc_draw_emitted_motion_line(const nc_preview_info_t *preview, int z0_x, int stock_w, int stock_top, int stock_h, const char *line, nc_preview_segment_t segment, bool selected, float *last_x, float *last_z, bool *have_last);
bool nc_draw_explicit_arc(const nc_preview_info_t *preview, int z0_x, int stock_w, int stock_top, int stock_h, float start_x, float start_z, float end_x, float end_z, float r, bool cw, lvds_color_t color, int width);
bool nc_draw_r_arc_center(float start_z, float start_x, float end_z, float end_x, float r, bool cw, nc_preview_v2_t *center);
...
int nc_draw_tool_polygon_points(int tip_x, int tip_y, int orient, int size, int *px, int *py);
...
void nc_draw_chuck(const nc_preview_info_t *preview, int stock_left, int stock_top, int stock_w, int stock_h);
void nc_draw_chuck_hatching(int x, int y, int w, int h, lvds_color_t color);
void nc_draw_chuck_relief(const nc_preview_info_t *preview, int stock_left, int stock_top, int stock_h);
void nc_draw_contour_point_marker(int x, int y, bool filled);
void nc_draw_dashdot_line(int x0, int y0, int x1, int y1, lvds_color_t color);
void nc_draw_dashed_segment(const nc_preview_info_t *preview, int z0_x, int stock_w, int stock_top, int stock_h, float z0, float x0, float z1, float x1, lvds_color_t color);
void nc_draw_diameter_dimension(int x, int y0, int y1, const char *label);
...
void nc_draw_preview_tool_panel(int x, int y, int w, int h, const nc_tool_t *tool);
...
void nc_draw_tool_polygon(int tip_x, int tip_y, int orient, int size, int thick, lvds_color_t fill, lvds_color_t edge, lvds_color_t mount);
void nc_draw_x_point_dimension(int dim_x, int start_y, int point_y, int zero_y, int point_x, const char *label);
void nc_draw_z_point_dimension(int start_x, int point_x, int zero_x, int center_y, int point_y, const char *label);
...
void nc_draw_tool_marker_line(int x1, int y1, int x2, int y2, lvds_color_t color, int thick);
