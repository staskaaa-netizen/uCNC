...
def main():
    ...
    header = (f'#ifndef {target_h.stem.upper()}_H\n#define {target_h.stem.upper()}_H\n\n'
              ...
              '   here: MANUAL\'s jog pad and EDIT\'s floating helper are two users of\n'
              '   one visual, not two drawings (the path builder, which was a third for\n'
              '   a week, proved the point). */\n\n'
              '#include <stdbool.h>\n#include <stdint.h>\n\n'
